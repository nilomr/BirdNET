...
# Get code to import custom list from https://github.com/kahst/BirdNET-Lite/blob/main/analyze.py#L203
...
def main():
    ...
    parser.add_argument(
        "--o",
        default="",
        help="Path to output directory. If not specified, the input directory will be used.",
    )
    parser.add_argument(
        "--filetype",
        default="wav",
